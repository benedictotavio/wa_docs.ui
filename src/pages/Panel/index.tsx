            ...
            <div className="col-md-4 col-lg-3 pl-0 m-0">
                <Menu>
                    <Tabs
                        ...
                        tabsContent={[
                            {
                                icon: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-braces-asterisk" viewBox="0 0 16 16">
                                ...
                                title: "Requisições",
                                content: <MenuItem text="Projeto 1" folders={[{ id: 1, name: "Folder 1" }, { id: 2, name: "Folder 2" }]} />,
                            },
                            {
                                icon: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-database-exclamation" viewBox="0 0 16 16">
